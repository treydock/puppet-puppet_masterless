...
# configuration is in /etc/puppetlabs/puppet/foreman.yaml
...
Puppet::Reports.register_report(:foreman_masterless) do
  ...
  def process
    begin
      ...
      SETTINGS[:ssl_cert] = "/etc/puppetlabs/puppet/ssl/certs/#{self.host}.pem"
      SETTINGS[:ssl_key] = "/etc/puppetlabs/puppet/ssl/private_keys/#{self.host}.pem"
